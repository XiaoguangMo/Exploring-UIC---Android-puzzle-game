...
public class xuexiao7 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xuexiao7);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao7.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao7.this,map.class);
				startActivity(intent);
			}
		});
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao7.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao7.this,xuexiao8.class);
		...
		button13.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao7.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao7.this,xuexiao4.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
