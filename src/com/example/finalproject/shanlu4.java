...
public class shanlu4 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shanlu4);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu4.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu4.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu4.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu4.this,shanlu10.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu4.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu4.this,shanlu5.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
		...
		button13.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu4.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu4.this,shanlu3.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
