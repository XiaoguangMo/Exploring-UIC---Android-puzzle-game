...
public class shanlu1 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu1.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu1.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu1.this,shanlu2.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu1.this,silu1.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
