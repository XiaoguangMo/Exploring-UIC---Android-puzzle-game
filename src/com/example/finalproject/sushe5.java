...
public class sushe5 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sushe5);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(sushe5.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(sushe5.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(sushe5.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(sushe5.this,sushe6.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(sushe5.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(sushe5.this,sushe4.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
...
//			public void onClick(View v){
//				MediaPlayer mediaPlayer01;
//				mediaPlayer01 = MediaPlayer.create(sushe4.this, R.raw.sound);
//				mediaPlayer01.start();
//				Intent intent=new Intent(sushe4.this,sushe3.class);
//				intent.putExtra("data",array);
//				startActivity(intent);
//			}
//		});
