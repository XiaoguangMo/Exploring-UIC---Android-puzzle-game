...
public class shanlu10 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shanlu10);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu10.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu10.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu10.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu10.this,shanlu11.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu10.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu10.this,shanlu4.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
