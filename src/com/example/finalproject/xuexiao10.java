...
public class xuexiao10 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xuexiao10);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao10.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao10.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao10.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao10.this,xuexiao11.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Toast toast2=Toast.makeText(getApplicationContext(), "I shouldn't go there.", Toast.LENGTH_SHORT);  
				toast2.show();
			}
		});
		...
		button13.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao10.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao10.this,xuexiao9.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
