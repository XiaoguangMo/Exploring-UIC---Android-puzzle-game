...
public class xuexiao8 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xuexiao8);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao8.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao8.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				if(array[6]==1){
					...
					mediaPlayer01 = MediaPlayer.create(xuexiao8.this, R.raw.sound);
					mediaPlayer01.start();
					Intent intent=new Intent(xuexiao8.this,xuexiao9.class);
					intent.putExtra("data",array);
					startActivity(intent);
				}
				else{
					Toast toast2=Toast.makeText(getApplicationContext(), "I need a key.", Toast.LENGTH_SHORT);  
					toast2.show();
				}
			}
		});
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao8.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao8.this,xuexiao7.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
