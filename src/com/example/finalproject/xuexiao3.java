...
public class xuexiao3 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xuexiao3);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao3.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao3.this,map.class);
				startActivity(intent);
			}
		});
//		if(array[5]==1){
...
//		});
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao3.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao3.this,xuexiao2.class);
		...
		button13.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao3.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao3.this,xuexiao4.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
