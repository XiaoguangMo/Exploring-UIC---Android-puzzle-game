...
public class shanlu12 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shanlu12);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu12.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(shanlu12.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu12.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu12.this,g1.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(shanlu12.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(shanlu12.this,shanlu11.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
