...
public class xuexiao15 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xuexiao15);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao15.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(xuexiao15.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				if(array[0]==1&&array[1]==1&&array[2]==1&&array[3]==1&array[4]==1&&array[5]==1){
					Intent intent=new Intent(xuexiao15.this,win.class);
					startActivity(intent);
				}
				else{
					Toast toast2=Toast.makeText(getApplicationContext(), "I should find other dragonballs.", Toast.LENGTH_SHORT);  
					toast2.show();
				}
			}
		});
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(xuexiao15.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(xuexiao15.this,xuexiao14.class);
...
//				mediaPlayer01 = MediaPlayer.create(xuexiao15.this, R.raw.sound);
//				mediaPlayer01.start();
//				Intent intent=new Intent(xuexiao15.this,xuexiao15.class);
//				intent.putExtra("data",array);
//				startActivity(intent);
//			}
//		});
