	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(g3.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(g3.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(g3.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(g3.this,g4.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(g3.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(g3.this,g2.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
