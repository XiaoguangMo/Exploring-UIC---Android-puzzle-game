	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(g1.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(g1.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(g1.this, R.raw.sound);
				mediaPlayer01.start();
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(g1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(g1.this,xuexiao1.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
		...
		button13.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(g1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(g1.this,shanlu12.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
