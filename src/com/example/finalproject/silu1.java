...
public class silu1 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.silu1);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(silu1.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(silu1.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(silu1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(silu1.this,shanlu1.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(silu1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(silu1.this,silu2.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
		...
		button13.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(silu1.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(silu1.this,sushe6.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
