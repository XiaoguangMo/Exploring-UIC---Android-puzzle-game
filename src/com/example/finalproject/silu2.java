...
public class silu2 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.silu2);
		Intent intent = this.getIntent();
		array = intent.getIntArrayExtra("data");
		button1 = (Button)this.findViewById(R.id.button1);
		button1.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(silu2.this,menu.class);
		...
		button10.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				Intent intent=new Intent(silu2.this,map.class);
				startActivity(intent);
			}
		});
		...
		button11.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(silu2.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(silu2.this,silu3.class);
		...
		button12.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				mediaPlayer01 = MediaPlayer.create(silu2.this, R.raw.sound);
				mediaPlayer01.start();
				Intent intent=new Intent(silu2.this,silu1.class);
				intent.putExtra("data",array);
				startActivity(intent);
			}
		});
...
//				mediaPlayer01 = MediaPlayer.create(silu2.this, R.raw.sound);
//				mediaPlayer01.start();
//				Intent intent=new Intent(silu2.this,sushe3.class);
//				intent.putExtra("data",array);
//				startActivity(intent);
//			}
//		});
